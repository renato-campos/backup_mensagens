...
class FileArchiver:
    def __init__(self, WATCH_FOLDER, archive_root, log_folder):
        ...
        self.setup_logger()
        # self.last_processed_type = None # Não é mais necessário para logging
    ...
    def setup_logger(self):
        ...
        try:
            ...
            log_file = os.path.join(
                self.log_folder, f"archive_failures_{timestamp}.log") # Nome do arquivo alterado para clareza
    ...
    def process_eml_file(self, eml_path):
        ...
        date_obj = self._parse_date(date_str, eml_path) # Passa o path para logs internos se necessário
        ...
        self.move_file_to_archive(eml_path, archive_folder) # Não precisa mais passar 'year'
    ...
    def process_other_file(self, file_path):
        ...
        self.move_file_to_archive(file_path, archive_folder) # Não precisa mais passar 'year'
    ...
    def _sanitize_filename(self, filename):
        ...
        sanitized = re.sub(r'^msg\s+', '', filename, flags=re.IGNORECASE) # Adicionado \s+ para remover o espaço seguinte também
    ...
    def move_file_to_archive(self, file_path, archive_folder):
        ...
        temp_final_filename = final_filename # Guarda o nome antes do loop de duplicados
...
def main():
    ...
    if log_files:
        ...
        for log_f in sorted(log_files, reverse=True): # Mostra o mais recente primeiro
            print(f"- {log_f}")
